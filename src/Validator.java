...
public class Validator
{
     ...
     * @return inputString
     */
    public static String getString(final String kPROMPT)
    {
     ...
     */
    public static BigDecimal getBigDecimal(String kPROMPT)
    {
        //declare local variable
     ...
     * @return inputDouble
     */
    public static Double getDouble(String kPROMPT)
    {
        //declare local variable
     ...
     * @return inputInt
     */
    public static int getInt(String kPROMPT)
    {
        //declare local variable
        int inputInt = 0;
